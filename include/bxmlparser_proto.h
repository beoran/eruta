...
'cfunctions -c -aoff -n -w bxmlparser_proto src/bxmlparser.c' */
#ifndef CFH_BXMLPARSER_PROTO
#define CFH_BXMLPARSER_PROTO

/* From 'src/bxmlparser.c': */

#line 20 "bxmlparser.rl"
...
BXMLNode * bxmlnode_alloc PROTO ((void));

#line 83 "bxmlparser.rl"
int bxmlragel_parse (struct BXMLRagel_ * parser , char * xmltext , int size );

#endif /* CFH_BXMLPARSER_PROTO */
