...
'cfunctions -c -aoff -n -w xmlparser_rb_proto src/xmlparser_rb.c' */
#ifndef CFH_XMLPARSER_RB_PROTO
#define CFH_XMLPARSER_RB_PROTO

/* From 'src/xmlparser_rb.c': */
Line number: 0
Line number: 0
Line number: 0

#line 25 "xmlparser_rb.rl"
extern class BXMLRagel attr_accessor buffer attr_accessor root attr_accessor now end class BXML NODE;
Line number: 0
...
end def walk  PROTO ((int /* default */ block));
Line number: 0
Line number: 0
Line number: 0
Line number: 0
...
def ragel_parse  PROTO ((int /* default */ text));
