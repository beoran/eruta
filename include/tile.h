...
/** Adds an "animation program" step to this tile. The program consists
* of a list of a single byte instructions. Of these bytes, the lower
* nybble is the opcode and the higher nybble the operand.
*/
