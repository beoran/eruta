...
.L01505 ;  hero_oldy = hero_start_x
	...
	LDA #hero_start_x
	STA hero_oldy
.L01506 ;  rem 'Give 3 bonus level ups

.L01507 ;  if hero_level  <  90 then hero_level  =  hero_level  +  3
...
.condpart206
	...
	STA hero_level
.skipL01507
.L01508 ;  hero_hp  =  hero_level  *  2  +  hero_base_hp
...
; complex statement detected
	...
	ADC #hero_base_hp
	STA hero_hp
.L01509 ;  hero_mp  =  hero_level  /  16  +  1
...
; complex statement detected
	...
	ADC #1
	STA hero_mp
.L01510 ;  gosub music_restart

 jsr .music_restart

.L01511 ;  gosub room_draw bank2
 ...
 jmp BS_jsr
ret_point30
.L01512 ;  gosub hero_draw_s bank1
...
.L01523 ;  rem COLUP1 = rand

.L01524 ;  rem COLUP0 = rand

.L01525 ;  rem REFP0 = 8

.L01526 ;  gosub music_play
...
.L01527 ;  drawscreen
 ...
 jmp BS_jsr
ret_point33
.L01528 ;  if switchreset  ||  joy0fire then return
...
.L01531 ;  data music_notes_gameover
...
.L01532 ;  data music_notes_victory
...
.skipL01533
.L01534 ;  rem 'restarts the music  

.music_restart
 ; music_restart

.L01535 ;  music_timer = 1

	LDA #1
	STA music_timer
.L01536 ;  music_pointer = 0
...
.L01540 ;  rem ' Update music timer and change note if needed

.L01541 ;  rem ' If we get here, the timer is not 0 yet. 

.L01542 ;  rem ' Go on to the next note, and leave it at that   

.L01543 ;  if music_timer  =  0 then goto music_do_note_change
...
.skipL01543
.L01544 ;  goto music_no_note_change
...
.L01545 ;  gosub music_change_note
...
.L01546 ;  music_timer  =  music_timer  -  1

	DEC music_timer
.L01547 ;  rem ' COLUBK = music_timer
...
.L01549 ;  rem ' choose the not from the right music table

.L01550 ;  if music_which  =  0 then temp1  =  music_notes_intro[music_pointer]
...
.condpart210
	...
	STA temp1
.skipL01550
.L01551 ;  if music_which  =  1 then temp1  =  music_notes_gameover[music_pointer]
...
.condpart211
	...
	STA temp1
.skipL01551
.L01552 ;  if music_which  =  2 then temp1  =  music_notes_victory[music_pointer]
...
.L01556 ;  AUDC1  =  12
	...
	LDA #12
	STA AUDC1
.L01557 ;  if temp1  =  0 then AUDV0  =  0 else AUDV0  =  4
...
.skipL01557
	...
	STA AUDV0
.skipelse5
.L01558 ;  if temp1  =  0 then AUDV1  =  0 else AUDV1  =  4
...
.skipL01558
	...
	STA AUDV1
.skipelse6
.L01559 ;  music_pointer  =  music_pointer  +  1

	INC music_pointer
.L01560 ;  rem ' Get right timig for note from right music

.L01561 ;  if music_which  =  0 then music_timer  =  music_notes_intro[music_pointer]
...
.condpart215
	...
	STA music_timer
.skipL01561
.L01562 ;  if music_which  =  1 then music_timer  =  music_notes_gameover[music_pointer]
...
.condpart216
	...
	STA music_timer
.skipL01562
.L01563 ;  if music_which  =  2 then music_timer  =  music_notes_victory[music_pointer]
...
.condpart217
	...
	STA music_timer
.skipL01563
.L01564 ;  music_pointer  =  music_pointer  +  1

	INC music_pointer
.L01565 ;  temp3  =  music_sizes[music_which]

	LDX music_which
	LDA music_sizes,x
	STA temp3
.L01566 ;  if music_which  =  0 then temp3  =  56
...
.condpart218
	...
	STA temp3
.skipL01566
.L01567 ;  if music_which  =  1 then temp3  =  20
...
.condpart219
	...
	STA temp3
.skipL01567
.L01568 ;  if music_which  =  2 then temp3  =  32
...
.condpart220
	...
	STA temp3
.skipL01568
.L01569 ;  if music_pointer  >=  temp3 then music_pointer  =  0
...
.L01574 ;  inline 6lives_statusbar.asm
