...
// Macros to wrap and unwrap SDL_Textures in GyTextures
#define GY_TEXTURE_UNWRAP(GYTEXTURE) ((SDL_Texture *)(GYTEXTURE))
#define GY_TEXTURE_WRAP(SDLTEXTURE)  ((GyTexture *)(SDLTEXTURE))
// Functions to wrap and unwrap SDL_Textures in GyTextures
GyTexture   * gytexture_wrap(SDL_Texture * texture);
SDL_Texture * gytexture_unwrap(GyTexture * texture);

// Macros to wrap and unwrap SDL_Renderers in GyCanvases
#define GY_CANVAS_UNWRAP(GY) ((SDL_Renderer *)(GY))
#define GY_CANVAS_WRAP(SDL)  ((GyCanvas *)(SDL))
