...
int main()
{
    ...
    const char *str = "<tag attr1='aaa' attr2=\"bbbb\" attr3='ccccc' attr4='dddddd' attr5=\"eeeeeee\">text</tag>";
    yxml_t *xml;
	clock_t t;
	int i, len = strlen(str), num = 150000;
	...
	*str1 = 0;
	...
	i = strlen(str1);
    printf("IN : string of %i chars (%i MB)\n", i, i/1024/1024);
	t = clock();
